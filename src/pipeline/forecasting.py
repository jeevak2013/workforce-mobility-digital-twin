...
def run_time_series_cv(
    ...
    logger.info(
        f"CV Mean R²: "
        f"{cv_results['cv_mean_r2']:.4f}"
    )

    logger.info(
        f"CV Mean RMSE: "
        f"{cv_results['cv_mean_rmse']:.4f}"
    )
...
def evaluate_model(
    ...
    logger.info(
        f"Final R² Score: {r2:.4f}"
    )

    logger.info(
        f"Final RMSE: {rmse:.4f}"
    )
...
def export_feature_importance(
    ...
    logger.info(
        "Feature importance artifacts exported."
    )
...
def export_outputs(
    ...
    logger.info(
        "Forecasting artifacts exported successfully."
    )
...
def main() -> None:
    ...
    logger.info(
        "Starting enterprise forecasting pipeline..."
    )
